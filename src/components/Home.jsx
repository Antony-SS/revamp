...
<Grid minHeight="100vh" width= "100%" 
  ...
  gap={0}>
      <GridItem rowSpan={{base: 1, md: 2}} colSpan={1} bg="#90CCF4" p={4} position= "relative" className="grid-item" minHeight={{ base : "100vh", md: "auto"}}>
        <Box as={Link} href="/work" display="block" w="100%" h="100%" padding={0} margin={0}>
          ...
          <Box position="absolute" bottom={0} left={0} right={0} h = {{base: "21%", md: "18%" }}  display="flex" textAlign = "left" flexDirection="column" paddingLeft="6%">
            ...
            <Text position={"relative"} top={5} fontSize={{base: 16, md: 14, lg: 16}}>
